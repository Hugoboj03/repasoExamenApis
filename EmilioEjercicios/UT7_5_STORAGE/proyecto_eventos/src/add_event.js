...
formulario.addEventListener('submit', async function (e) {
    ...
    reader.onload = async function (e) {
        ...
        try {
            ...
            console.log("Imagen Base64:", e.target.result);


            if (!resp.ok) {
                console.error("Error al insertar el evento");
            } else {
                location.assign("../index.html");
            }
        } catch (error) {
            console.error("Fallo insertando el Evento:", error); // Ahora esto debería funcionar
            alert("Fallo insertando el Evento: " + error.message);
        }
    };
